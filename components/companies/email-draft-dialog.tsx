...
function EmailDraftModal({
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div className="fixed left-1/2 top-1/2 z-50 w-full max-w-2xl -translate-x-1/2 -translate-y-1/2 rounded-xl border border-slate-200 bg-white shadow-2xl dark:border-slate-800 dark:bg-zinc-900">
        {/* Header */}
          ...
          {state.phase === "loading" ? (
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm dark:border-slate-700 dark:bg-zinc-800">
              ...
              <div>
                ...
                <div className="relative rounded-lg border border-slate-200 bg-slate-50 dark:border-slate-700 dark:bg-zinc-800">
  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === "outline"
          ? "border border-slate-200 hover:bg-slate-50 dark:border-slate-700 dark:hover:bg-zinc-800"
